...
export default function ResetModalHeading({closeModal}: pageProps) {
    const headline = 'Reset Your Password';
    const subtext =  'Enter your email to get a link and get back to managing your inventory fast.'
